...
def test_overflow_toDate32(start_cluster):
    ...
    assert node.query("SELECT toDate32('1000-12-31','UTC')") == "1000-01-01\n"
    assert node.query("SELECT toDate32('0000-01-01','UTC')") == "0000-01-01\n"
    assert node.query("SELECT toDate32('9999-01-01','UTC')") == "9999-01-01\n"
